...
class ProductAccountServiceTest {
    ...
    void setUp() {
        ...
        this.productAccount.setName("QUESO");
        this.productAccount.setDescription("QUESO FRESCO");
        this.productAccount.setMinimunBalance(new BigDecimal(20));
        this.productAccount.setPayInterest("2%");
    ...
    void obtainById() {
        ...
        assertNotNull(productAccountService.obtainById("123"));
    }
